...
public class PropertyEntity implements StorableData {
    ...
    PropertyEntity(int size)
    {
        this( new byte[size] );
    }

    public PropertyEntity(byte[] buffer)
    {
        this.buffer = buffer;
    }
    ...
    public PropertyEntity putByte(int offset, byte value)
    {
    ...
    public PropertyEntity putShort(int offset, short value)
    {
    ...
    public PropertyEntity putChar(int offset, char value)
    {
        return putValue( offset, value, 2 );
    }
    ...
    public PropertyEntity putInt(int offset, int value)
    {
    ...
    public PropertyEntity putLong(int offset, long value)
    {
        return putValue( offset, value, 8 );
    }


    public PropertyEntity put(int offset, byte[] value)
    {
    ...
    private PropertyEntity putValue(int offset, long value, int size)
    {
